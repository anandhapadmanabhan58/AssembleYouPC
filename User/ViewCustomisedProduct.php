                        ...
                        ?>
                                ...
                                <div class="col-lg-4 col-md-6 mt-md-0 mt-5" style="margin-bottom: 25px">
                                    <div class="grids5-info">
                                        <a href="ViewCustomProById.php?id=<?php echo $row['cpid'] ?>" class="d-block zoom"><img src="../<?php echo $row['img'] ?>" alt="" class="img-fluid news-image"></a>
                                        <div class="blog-info card-body blog-details px-lg-0">
                                            ...
                                            <a href="ViewCustomProById.php?id=<?php echo $row['cpid'] ?>" class="blog-desc"><?php echo $row['brand'] ?> <?php echo $row['display'] ?></a>
