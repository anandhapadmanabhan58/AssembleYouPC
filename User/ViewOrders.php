    ...
    <div id="grids5-block" class="py-5">
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="title-content text-center mb-5">
                ...
                <h3 class="title-w3l mb-4">Orders </h3>
            </div>
            <div class="row mt-lg-5 mt-4 text11-content">
                ...
                $uid = $_SESSION['USERID'];
                $qry = mysqli_query($conn, "SELECT DISTINCT c.`cartid`,p.*,c.`status` FROM `cart` c,`product` p WHERE p.`pid`=c.`pid` AND c.`uid`='$uid' AND c.`status`!='Cart'");
                        ...
                        <div class="col-lg-4 col-md-6 mt-md-0 mt-5" style="margin-bottom: 25px">
                            <div class="grids5-info">
                                ...
                                <div class="blog-info card-body blog-details px-lg-0">
                                    ...
                                    <p>Current Status : <?php echo $row['status'] ?></p>
                                </div>
                            </div>
                        </div>
