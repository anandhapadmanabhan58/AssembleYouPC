                ...
                <div class="container py-lg-5 py-md-4 py-2">
                    <div class="row">
                        ...
                        <div class="col-lg-6 pl-lg-5 mt-lg-0 mt-4">
                            ...
                            <a href="../Action/MarkCustomDelivered.php?id=<?php echo $row['cpid'] ?>" class="btn btn-outline-success btn-style mt-md-5 mt-4 ml-3"> Delivered<span class="fa fa-truck ml-2"></span></a>
                        </div>
                    </div>
                </div>
            </div>
