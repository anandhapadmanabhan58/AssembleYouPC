...
<section class="w3l-contact-main" id="contact">
    <div class="contact-infhny py-5">
                ...
                <div class="map-content-9">
                    ...
                    <form method="post">
                        <div class="form-top1">
                            ...
                            <h3 class="title-w3l text-center mb-2">Processor</h3>

                            <div class="form-top" style="margin: 25px;">

                                <div class="form-top-left">
                                    <input type="text" name="processor" id="w3lName" placeholder="Processor" required="">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $sel = mysqli_query($conn, "SELECT COUNT(*) AS COUNT FROM `processor` WHERE `processor`='$processor' and brand='$cat'");
                        $fetch = mysqli_fetch_array($sel);
                        if ($fetch['COUNT'] > 0) {
                            echo '<script>alert("Already Added")</script>';
                        } else {
                            $qry = "INSERT INTO `processor`(`processor`,`size`,`speed`,`speciality`,`rate`,`brand`)VALUES('$processor','$size','$speed','$speciality','$rate','$cat')";
        ...
        <?php
        $qry = mysqli_query($conn, "SELECT * FROM `processor`");
            ...
            <table id="customers">
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="../Action/RemoveProcessor.php?id=<?php echo $row['proid'] ?>"><button type="submit" name="submit" class="btn btn-style alert-primary"><i class="fa fa-trash ml-lg-3"></i></button></a></td>
                    </tr>
