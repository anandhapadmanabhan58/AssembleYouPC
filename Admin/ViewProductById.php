                ...
                <div class="container py-lg-5 py-md-4 py-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 pl-lg-5 mt-lg-0 mt-4">
                            ...
                            <a href="../Action/RemoveProduct.php?id=<?php echo $row['pid'] ?>" class="btn btn-outline-danger btn-style mt-md-5 mt-4 ml-3"> Remove <span class="fas fa-trash ml-2"></span></a>
