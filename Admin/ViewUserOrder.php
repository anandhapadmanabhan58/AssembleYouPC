...
<section class="w3l-features py-5" id="work">
    <div class="container py-lg-5 py-md-4 py-2">
        ...
        <div class="row main-cont-wthree-2 align-items-center">
            ...
            $qry = mysqli_query($conn, "SELECT DISTINCT u.* FROM `cart` c,`user` u,`product` p WHERE c.`uid`=u.`uid` AND p.`pid`=c.`pid` AND c.`status`='paid'");
            ...
            ?>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="grids-1 box-wrap">
                            ...
                            <h4><a href="ViewProductsByUid.php?id=<?php echo $row['uid'] ?>" class="title-head mb-3"><?php echo $row['name'] ?></a></h4>
